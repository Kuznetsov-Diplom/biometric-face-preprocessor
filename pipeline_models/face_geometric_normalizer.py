...
class FaceGeometricNormalizer(PipelineStep):
    ...
    def process(self, context: PipelineContext) -> PipelineContext:
        ...
        # 1. Центры глаз
        left_eye, right_eye = self._get_eye_centers(landmarks_points)
        ...
        # 4. Аффинное преобразование (поворот + масштаб + сдвиг)
        ...
        # 6. Нормализуем ландмарки (применяем ту же матрицу)
        norm_landmarks = []
        ...
        context.aligned_face = aligned          # новое поле (будет использовано дальше)
